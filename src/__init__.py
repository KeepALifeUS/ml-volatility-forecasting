...
Enterprise-grade volatility forecasting system с GARCH моделями,
реализованной волатильностью, implied volatility.
...
- Real-time API и WebSocket streaming
- Trading integration с position sizing
